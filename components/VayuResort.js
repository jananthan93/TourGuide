      ...
      <View >
        ...
        <ScrollView>
          ...
          {'\t'}
            ...
            of Earth, Wind, Water !{'\n'}{'\n'}{'\t'} For those we know : the spot offers exactly
            the same condition as Vella island or Magic spot in Kalpitiya !{'\n'}{'\n'}{'\t'} Our
            location is at the beginning of the Adam’s Bridge on the Mannar
            peninsula. You will not get a better location than this for
            ...
            you a hassle free and safe experience.’{'\n'}{'\n'}{'\t'} The Kitecamp consists of 12
            bungalows, 8 deluxe tents, a dining area, a bar and many areas to
            chill and relax. All meals are included in the price as well as tea
            and coffee around the clock.{'\n'}{'\n'}{'\t'} The sunsets as well as the starry
            nights are stunning. The Vayu camp also offers Yoga, Massage, SUP,
            Kayaks and nature-based excursions. All bungalows have a 2 – 4 bed
            option, open-air stars showers and a verandah for you to relax.{'\n'}{'\n'}{'\t'} As
            with our setup in Kalpitiya, the vibes will remain the same. We
            continue to be a rustic location with lots of care and attention to
            detail. We offer Western and Local food. The local food reflects the
            different culture and cuisine that’s found in the North of Sri
            ...
            sandbanks of Mannar are well-known for strong winds and as a
            sanctuary for numerous migratory birds. You are in an Ornitholgists
            Dream Escape with countless species that can be spotted from your
            verandah!{'\n'}{'\n'}
          </Text>
        </ScrollView>
